export default {
  key: "caminhao-pipa",
  title: "CHECKLIST DE PRE-USO DE INSPECAO MOVEL - CAMINHAO PIPA",
  version: "rev03",
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "13", text: "Farol de re e alarme de re", type: "yesno" },
        ...
        { id: "18", text: "Verificar Farois, setas, piscas alertas e lanternas do tanque", type: "yesno" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "24", text: "Avaliar cardam, cruzetas e luva do estriado", type: "yesno" }
      ]
    },
    {
      title: "400 - SISTEMA DE FREIOS",
      items: [
        { id: "25", text: "Verificar Cuica de freio (desgaste e vazamentos nas mangueiras, conexoes e parafusos)", type: "yesno" },
        { id: "26", text: "Avaliar em operacao funcionamento o acionamento do freio motor", type: "yesno" },
        { id: "27", text: "Testar funcionamento do freio estacionario", type: "yesno" },
        { id: "28", text: "Avaliar nivel de fluido de freio", type: "yesno" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "34", text: "Avaliar fixacao das grades laterais inferiores de protecao e para-choques", type: "yesno" },
        { id: "35", text: "Avaliar retrovisores", type: "yesno" },
        { id: "36", text: "Verificar Macanetas externas e internas do caminhao", type: "yesno" },
        { id: "37", text: "Limpeza da cabine do caminhao", type: "yesno" },
        { id: "38", text: "Verificar Nivel de agua e funcionamento dos limpadores parabrisa", type: "yesno" },
        { id: "39", text: "Verificar Chuveiro, para-choque, escada de acesso ao tanque", type: "yesno" }
      ]
    },
    {
      ...
      items: [
        ...
        { id: "44", text: "Verificar Diferencial (carcaca, fixacao)", type: "yesno" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "56", text: "Realizar 5s da cabine do caminhao", type: "yesno" }
      ]
    }
  ]
};
