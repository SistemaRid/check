export default {
  key: "caminhao-munck",
  title: "CHECKLIST DE PRÉ-USO DE INSPEÇÃO MÓVEL - CAMINHÃO MUNCK",
  version: "rev03",
  ...
  sections: [
...

    {
      ...
      items: [
        ...
        { id: "18", text: "Verificar faróis, setas, piscas alertas e lanternas", type: "yesno" },
...

    {
      ...
      items: [
        ...
        { id: "27", text: "Avaliar funcionamento do freio estacionário", type: "yesno" },
        { id: "28", text: "Avaliar nível de fluido de freio", type: "yesno" },
        { id: "29", text: "Verificar funcionamento dos freios", type: "yesno" }
      ]
    },

    {
      ...
      items: [
        { id: "30", text: "Escada de acesso ao compartimento do motorista", type: "yesno" },
        ...
        { id: "39", text: "Verificar as patolas e descansos para patolas", type: "yesno" }
      ]
    },
    ...
    {
      title: "700 - SISTEMA HIDRÁULICO / GUINDASTE",
      items: [
        ...
        { id: "46", text: "Verificar cilindros hidráulicos e mangueiras", type: "yesno" },
        { id: "47", text: "Verificar trincas na estrutura do guindaste", type: "yesno" },
        { id: "48", text: "Verificar articulações do braço e lanças do guindaste", type: "yesno" },
        { id: "49", text: "Verificar gancho, cintas e correntes", type: "yesno" },
        { id: "50", text: "Verificar alavancas de controle do guindaste", type: "yesno" },
        { id: "51", text: "Verificar estrutura de giro", type: "yesno" }
      ]
    },

    {
      ...
      items: [
        { id: "52", text: "Verificar condições dos parafusos e porcas das rodas", type: "yesno" },
        { id: "53", text: "Verificar banda de rodagem dos pneus ou cortes", type: "yesno" }
      ]
    },

    {
      ...
      items: [
        ...
        { id: "57", text: "Verificar posicionamento da maçaneta para saída de emergência", type: "yesno" },
        { id: "58", text: "Realizar 5S da cabine e carroceria do caminhão", type: "yesno" }
      ]
    }
