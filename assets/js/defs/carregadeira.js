export default {
  key: "carregadeira",
  title: "CHECKLIST DE PRÉ-USO DE INSPEÇÃO MÓVEL - CARREGADEIRA",
  version: "rev03",
  ...
  sections: [
...

    {
      ...
      items: [
        ...
        { id: "13", text: "Testar alarme de ré e buzina", type: "yesno" },
...

    {
      ...
      items: [
        { id: "22", text: "Testar freio estacionário", type: "yesno" },
...

    {
      ...
      items: [
        ...
        { id: "27", text: "Verificar para-choque, paralamas e para-brisa quanto a trincas", type: "yesno" },
        { id: "28", text: "Verificar retrovisores", type: "yesno" },
        { id: "29", text: "Verificar escadas e corrimão de acesso à cabine da máquina", type: "yesno" },
        { id: "30", text: "Verificar níveis de água no reservatório de limpeza do para-brisa", type: "yesno" },
        { id: "31", text: "Verificar funilaria em geral procurando arranhões ou avarias", type: "yesno" }
      ]
    },

    {
      ...
      items: [
        ...
        { id: "35", text: "Avaliar possível folga na barra de direção", type: "yesno" },
        { id: "36", text: "Avaliar funcionamento do volante", type: "yesno" },
        { id: "37", text: "Verificar cilindros de direção", type: "yesno" }
      ]
    },

    {
      ...
      items: [
        { id: "38", text: "Verificar cilindros de elevação do braço", type: "yesno" },
        { id: "39", text: "Verificar cilindros da concha", type: "yesno" },
        { id: "40", text: "Verificar nível de óleo hidráulico", type: "yesno" },
        { id: "41", text: "Verificar vazamentos no sistema hidráulico geral", type: "yesno" },
        { id: "42", text: "Verificar condições de pinos e buchas dos braços", type: "yesno" }
      ]
    },

    {
      ...
      items: [
        { id: "43", text: "Verificar condições dos pneus (calibragem, cortes e banda de rodagem)", type: "yesno" },
        { id: "44", text: "Verificar prisioneiros das rodas", type: "yesno" }
      ]
    },

    {
      ...
      items: [
        { id: "45", text: "Verificar estados e condições do cinto de segurança", type: "yesno" },
        { id: "46", text: "Verificar banco do operador (fixação, encosto, amortecedor, ajuste)", type: "yesno" },
        { id: "47", text: "Verificar extintor de incêndio (suporte, pressão, lacre e validade)", type: "yesno" },
        { id: "48", text: "Verificar posicionamento da maçaneta para saída de emergência", type: "yesno" },
        { id: "49", text: "Realizar 5S da cabine do equipamento e demais pontos necessários", type: "yesno" }
      ]
    }
