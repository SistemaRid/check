export default {
  key: "carregadeira",
  title: "CHECKLIST DE PRE-USO DE INSPECAO MOVEL - CARREGADEIRA",
  version: "rev03",
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "13", text: "Testar Alarme de re e buzina", type: "yesno" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "19", text: "Conferir o torqueamento dos prisioneiros das rodas", type: "yesno" },
    ...
    },
    {
      ...
      items: [
        { id: "22", text: "Testar Freio estacionario", type: "yesno" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "34", text: "Avaliar ruidos anormais em carda/cruzetas", type: "yesno" },
        { id: "35", text: "Avaliar possivel folga existente na barra de direcao", type: "yesno" },
        { id: "36", text: "Avaliar funcionamento do volante", type: "yesno" },
        { id: "37", text: "Verificar cilindros de direcao", type: "yesno" }
      ]
    },
    {
      title: "700 - SISTEMA HIDRAULICO / LANCA",
      items: [
        { id: "37", text: "Verificar cilindros de elevacao do braco", type: "yesno" },
        { id: "38", text: "Verificar cilindros da concha", type: "yesno" },
        { id: "39", text: "Verificar condicoes de pinos e buchas dos bracos", type: "yesno" },
        { id: "40", text: "Verificar nivel do oleo hidraulico", type: "yesno" },
        { id: "41", text: "Verificar a presenca de vazamentos pelo sistema hidraulico geral da maquina", type: "yesno" }
      ]
    },
    {
      title: "800 - SISTEMA MATERIAL RODANTE / PNEUS",
      items: [
        { id: "42", text: "Verificar condicoes dos pneus quanto (Calibragem, Cortes, Banda de Rodagem)", type: "yesno" },
        { id: "43", text: "Verificar prisioneiros das rodas", type: "yesno" }
      ]
    },
    {
      title: "900 - ITENS DE SEGURANCA",
      items: [
        { id: "44", text: "Verifique o banco do operador (fixacao, encosto, amortecedor, ajuste)", type: "yesno" },
        { id: "45", text: "Verificar estados e condicoes do cinto de seguranca", type: "yesno" },
        { id: "46", text: "Verificar extintor de incendio (suporte, Pressao, Lacre e Validade)", type: "yesno" },
        { id: "47", text: "Verificar posicionamento da macaneta para caso de saida de emergencia", type: "yesno" },
        { id: "48", text: "Realizar 5s da cabine do equipamento e demais pontos necessarios pela maquina", type: "yesno" }
      ]
    }
  ]
};
